...
@DgsDataLoader(name = "connectedEmployer")
class ConnectedEmployerLoader(private val userService: UserService) :
    ...
    override fun load(
        ...
        val results = userService.findConnectedEmployersByUserIds(command)
