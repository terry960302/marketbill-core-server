package kr.co.marketbill.marketbillcoreserver.legacy.infrastructure.security
...
class JwtProvider(
    ...
    @Deprecated(message = "This function for cookie-based jwt authentication.")
    fun setAllTokensToHttpOnlyCookie(response: HttpServletResponse, newToken: kr.co.marketbill.marketbillcoreserver.legacy.application.dto.response.AuthTokenDto) {
