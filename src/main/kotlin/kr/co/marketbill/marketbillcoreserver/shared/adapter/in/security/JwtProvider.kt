...
import kr.co.marketbill.marketbillcoreserver.shared.adapter.out.persistence.CustomUserDetailsService
...
class JwtProvider(
    ...
    fun getAuthentication(token: String): Authentication {
        ...
        val cred = userDetailsPort.loadUserById(userId)
...
//        if (cookies.isEmpty() || tokens.isEmpty()) throw MarketbillException(
...
//
//    @Deprecated(message = "This function for cookie-based jwt authentication.")
//    fun setAllTokensToHttpOnlyCookie(response: HttpServletResponse, newToken: AuthT) {
