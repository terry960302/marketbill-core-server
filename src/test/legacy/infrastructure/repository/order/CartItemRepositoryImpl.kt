...
class CartItemRepositoryImpl : QuerydslRepositorySupport(CartItem::class.java), CartItemRepositoryCustom {
    ...
    override fun countTotalPaginatedCartItemsBySessionIds(sessionIds: List<Long>): List<kr.co.marketbill.marketbillcoreserver.legacy.application.dto.request.GroupedCartItemCountDto> {
        ...
        val query = queryFactory.select(
            Projections.constructor(
                kr.co.marketbill.marketbillcoreserver.legacy.application.dto.request.GroupedCartItemCountDto::class.java,
