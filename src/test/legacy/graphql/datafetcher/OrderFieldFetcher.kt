...
import kr.co.marketbill.marketbillcoreserver.legacy.application.dto.response.CartItemsOutput
...
import kr.co.marketbill.marketbillcoreserver.presentation.graphql.dataloader.CartItemLoader
import kr.co.marketbill.marketbillcoreserver.presentation.graphql.dataloader.CustomOrderItemLoader
import kr.co.marketbill.marketbillcoreserver.presentation.graphql.dataloader.OrderItemLoader
import kr.co.marketbill.marketbillcoreserver.presentation.graphql.dataloader.OrderSheetReceiptLoader
import kr.co.marketbill.marketbillcoreserver.shared.constants.FlowerGrade
import kr.co.marketbill.marketbillcoreserver.shared.util.EnumConverter
...
class OrderFieldFetcher {
    ...
    fun cartItems(
    ...
    ): CompletableFuture<kr.co.marketbill.marketbillcoreserver.legacy.application.dto.response.CartItemsOutput> {
        ...
        return result.thenApply {
            kr.co.marketbill.marketbillcoreserver.legacy.application.dto.response.CartItemsOutput(
