...
import kr.co.marketbill.marketbillcoreserver.legacy.application.event.BizConnectionCreatedEvent
import kr.co.marketbill.marketbillcoreserver.legacy.application.event.BizConnectionUpdatedEvent
...
import kr.co.marketbill.marketbillcoreserver.legacy.domain.specs.BizConnSpecs
...
class UserService {
     ...
     */
    @Transactional
    fun signUp(input: SignUpInput): kr.co.marketbill.marketbillcoreserver.legacy.application.dto.response.AuthTokenDto {
    ...
    @Transactional
    fun signIn(input: SignInInput): kr.co.marketbill.marketbillcoreserver.legacy.application.dto.response.AuthTokenDto {
    ...
    fun createBizConnection(retailerId: Long, wholesalerId: Long): BizConnection {
            ...
            eventPublisher.publishEvent(
                kr.co.marketbill.marketbillcoreserver.legacy.application.event.BizConnectionCreatedEvent(
                    this,
    ...
    fun updateBizConnection(bizConnId: Long, status: ApplyStatus): BizConnection {
            ...
            if (status != ApplyStatus.APPLYING) {
                eventPublisher.publishEvent(
                    kr.co.marketbill.marketbillcoreserver.legacy.application.event.BizConnectionUpdatedEvent(
                        this,
                        status = status,
                        targetPhoneNo = targetPhoneNo,
